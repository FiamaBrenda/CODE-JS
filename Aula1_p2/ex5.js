...
let compra = parseFloat(prompt("Digite o valor total da compra: "))

if(compra > 100 && compra <= 200){
    let desconto = compra - (compra/10)
    console.log( "o valor total da compra e: " + desconto)
}else if(compra > 200){
    let desconto = compra - (compra/5)
    console.log( "o valor total da compra e: " + desconto)
}else{
    console.log( "Neste caso nao tem desconto " )
}