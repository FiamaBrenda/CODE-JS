...
let altura = parseFloat(prompt("Digite sua altura: Ex 1.50 "))
let imc = peso / ( altura * altura)

if( imc < 18.5){
    console.log(" seu imc e: " + imc + " vc estaAbaixo do peso")
    
}else if(imc >= 18.5 && imc < 24.9) {
    console.log(" seu imc e: " + imc + " vc esta com Peso normal")

}else if(imc >= 25.0 && imc < 29.9) {    
    console.log(" seu imc e: " + imc + " vc esta Sobrepeso")
    
}else if(imc >= 30.0 && imc < 34.9) {
    console.log(" seu imc e: " + imc + " vc esta Obesidade grau 1")
    
}else if(imc >= 35.0 && imc < 39.9) {   
    console.log(" seu imc e: " + imc + " vc esta Obesidade grau 2")
    
}else{
    console.log(" seu imc e: " + imc + " vc esta Obesidade grau 3")
